...
public class MailIslemleri {
    ...
    protected void propertiesDegerleriniOlustur(){
        ...
        this.properties.put("mail.smptp.auth", "true");
        this.properties.put("mail.smptp.starttls.enable", "true");
        this.properties.put("mail.smptp.host", "smtp.gmail.com");
        this.properties.put("mail.smptp.port", "587");
