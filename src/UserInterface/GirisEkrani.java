...
public class GirisEkrani extends javax.swing.JFrame {
    ...
    SQLKullaniciIslemleri sqlKullaniciIslemleri = new SQLKullaniciIslemleri();
    
    
    public Integer posX;
    public Integer posY;
    
    public String kullaniciAdi = "emre";
    public String kullaniciSifre = "12345";
        ...
        if(!kullaniciAdi.equals("")){
            ...
            if(dialogButton == 0){ //yes
                ...
                SwingWorker<Boolean, Integer> worker = new SwingWorker<Boolean, Integer>() {
                    ...
                    protected void done() {
                        initComponents2(false);
                        System.out.println("Sureniz Bitti");
    ...
    private void jButton_GirisYapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GirisYapActionPerformed
        ...
        if(girilenKullaniciAdi.equals("")&&(girilenKullaniciSifre.equals(""))){
        ...
        }else if(girilenKullaniciSifre.equals("")){
            JOptionPane.showMessageDialog(this, "Şifre giriniz...");
        }else{
            if(girilenKullaniciAdi.equals(kullaniciAdi)&& Objects.equals(girilenKullaniciSifre,kullaniciSifre)){
